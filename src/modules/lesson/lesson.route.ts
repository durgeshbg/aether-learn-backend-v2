...
router.get('/', validateParams(LessonCourseIdParamsSchema), LessonController.findAll);
...
router.get('/:id', validateParams(LessonIdParamsSchema), LessonController.findById);
